...
minuteException::minuteException()
{

    msg = "The minutes are invalid. Valid values are between 0 and 59.";
}
...
secondException::secondException()
{
    ...
    msg = "The seconds are invalid. Valid values are between 0 and 59.";
}
